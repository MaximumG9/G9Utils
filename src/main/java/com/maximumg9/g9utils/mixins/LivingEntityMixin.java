...
public abstract class LivingEntityMixin {
    ...
    private void modifySidewaysSpeed(LivingEntity entity, float value) {
        entity.sidewaysSpeed = G9utils.getOptions().deceleration ? entity.sidewaysSpeed * 0.98f : entity.sidewaysSpeed;
    }
    ...
    private void modifyForwardsSpeed(LivingEntity entity, float value) {
        entity.forwardSpeed = G9utils.getOptions().deceleration ? entity.forwardSpeed * 0.98f : entity.forwardSpeed;
    }
}
