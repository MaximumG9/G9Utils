...
public abstract class LivingEntityMixin {
    ...
    public void hasNoDrag(CallbackInfoReturnable<Boolean> cir) {
        cir.setReturnValue(!G9utils.opt().deceleration || this.noDrag);
    }
    ...
    private void modifySidewaysSpeed(LivingEntity entity, float value) {
        entity.sidewaysSpeed = G9utils.opt().deceleration ? entity.sidewaysSpeed * 0.98f : entity.sidewaysSpeed;
    }
    ...
    private void modifyForwardsSpeed(LivingEntity entity, float value) {
        entity.forwardSpeed = G9utils.opt().deceleration ? entity.forwardSpeed * 0.98f : entity.forwardSpeed;
    }
}
